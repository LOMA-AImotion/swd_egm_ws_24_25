...
def show_number(pressed_number:int):
    tkinter.messagebox.showinfo("THI-SWD", f"You pressed the {pressed_number} button.")
...
for row in range(0, 3):
    for col in range(0, 3):
        ...
        next_button.config(command = partial(show_number, i))
